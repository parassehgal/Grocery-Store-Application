...
class Add : AppCompatActivity(), View.OnClickListener {
    override fun onClick(view: View?) {
        Toast.makeText(this,"kshksv",Toast.LENGTH_LONG).show()
        when(view!!.id)
        {
            R.id.image01->{
                val intent=Intent(this,NewUpdateActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this,"akmsakd",Toast.LENGTH_LONG).show()
